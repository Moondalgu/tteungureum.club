...
// 픽셀 하늘 배경 (단일 레이어, 리니어 등속 드리프트) + 구름 퍼프 이스터에그.
// 기본은 항상 움직임 — 끄기는 프로필 > 화면 효과 토글(localStorage "skyMotion" = "off").
...
export function Sky() {
  // 저장된 모션 설정 복원 ("off"만 의미 있음 — 기본은 움직임)
  useEffect(() => {
    if (localStorage.getItem("skyMotion") === "off") {
